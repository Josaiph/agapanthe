...
function breadcrumb_trail( $args = array() ) {
	...
	elseif ( is_archive() ) {
		...
		elseif ( is_date() ) {
			...
			if ( is_day() ) {
				$trail[] = '<a href="' . get_year_link( get_the_time( __( 'Y', 'am' ) ) ) . '" title="' . get_the_time( __( 'Y', 'am' ) ) . '">' . get_the_time( __( 'Y', 'am' ) ) . '</a>';
				$trail[] = '<a href="' . get_month_link( get_the_time( __( 'Y', 'am' ) ), get_the_time( __( 'm', 'am' ) ) ) . '" title="' . get_the_time( __( 'F', 'am' ) ) . '">' . get_the_time( __( 'F', 'am' ) ) . '</a>';
